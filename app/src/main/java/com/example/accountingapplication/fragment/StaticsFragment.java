...
public class StaticsFragment extends Fragment {
    ...
    private void initView(View view) {
        ...
        entries.add(new PieEntry(12, "餐饮"));
        entries.add(new PieEntry(17, "衣服"));
        entries.add(new PieEntry(20, "房子"));
        entries.add(new PieEntry(22, "购物"));
        entries.add(new PieEntry(25, "其他"));
